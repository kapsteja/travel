...
const Dashboard = () => {
    ...
    return (
        // <div>
        //     <button onClick={goToSample}>sample</button>
        // </div>
...
<Header />
            ...
            <div className="no-bottom no-top zebra" id="content">
                ...
                <section id="subheader" className="jarallax text-light">
                    <img src={require("../images/background/vihari-travels.jpg")} style={{ "width": "100%", "maxHeight": "270px" }} className="jarallax-img" alt="" />
